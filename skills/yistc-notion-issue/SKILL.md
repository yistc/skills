...
- You will be assigned an issue with issue ID such as 'KIS-7'. This ID is a Notion database page property, not the page ID you need for mcp operations. You need to search for this page first and get the page id

- You need to strictly follow and set tasks for steps listed below.

## Steps
### Step 1: Read and understand the issue
Before making changes:
- Read the issue title, description, comments, and any linked context.
- If the issue is ambiguous, state the ambiguity clearly in the Notion page before proceeding.
...
- Add a comment in the 'Initial Update' toggle:
...
- Rely on the repository’s GitHub Actions / CI to perform full validation after the PR is opened.
...
- specify the issue ID, e.g., "closes KIS-12"
- explain the problem,
...
If no test actions are configured for this project, ignore this step.
...
Add an update toggle to the Notion issue pae containing:
...
If you are blocked, update in Notion explaining:
  - what blocked you
  - what you tried
